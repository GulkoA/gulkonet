...
<Figure filenames={["blog/nerf_function.svg", "blog/nerf_projections.png"]} alt="NeRF workflow from input images at different perspectives to rendering new views" caption=""></Figure>
...
Since camera position and direction are independently parametarized, NeRF can model change of one independently from other. For example, here we have fixed camera viewpoint, while viewing direction varies:
...
[^8]: Ben Mildenhall and Pratul P. Srinivasan and Matthew Tancik and Jonathan T. Barron and Ravi Ramamoorthi and Ren Ng. NeRF: Representing Scenes as Neural Radiance Fields for View Synthesis. 2020. https://www.matthewtancik.com/nerf
